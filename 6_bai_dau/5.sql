...
create table Rooms(
    ...
    room_type_id int not null ,foreign key (room_type_id) references RoomTypes(room_type_id),
...
create table Bookings(
    ...
    room_id int not null , foreign key (room_id) references Rooms(room_id),
...
create table Payments(
    ...
    --unique de 1-1
    booking_id int not null unique, foreign key (booking_id) references Bookings(booking_id),
